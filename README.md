...
* Os código e refactorings realizados nesta aula prática podem ser usados em trabalhos científicos futuros do nosso grupo de pesquisa. Evidentemente, sempre de forma totalmente anônima (isto é, sem qualquer possibilidade de identificar os alunos). Caso você não se sinta à vontade com isso, basta nos enviar um e-mail, solicitando que seu código não seja usado futuramente.
